...
if(!ISSET($_SESSION['Correo'])){
    ...
    $sql = "SELECT * FROM wishlist JOIN paquetes ON paquetes.id_pack = wishlist.pid WHERE wishlist.bool = '1'";
...
<?php
    ...
    $sql = "SELECT * FROM wishlist JOIN hoteles ON hoteles.id_hotel = wishlist.pid WHERE wishlist.bool = '0'";
    $result = mysqli_query($conn, $sql);
